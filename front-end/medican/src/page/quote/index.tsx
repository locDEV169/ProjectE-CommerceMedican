    ...
    <form id="cart_form">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="item-image">
                <img src="/images/cms/thumb/xstream_1105100-_rgb_web_jan11_2019-2.jpg" />
              </td>
      ...
      <div className="checkout-navigation">
        <Link to="" className="button info">
          <i className="material-icons">chevron_left</i> Continue Browsing
        </Link>
        <Button
          // type="submit"
          value="Checkout"
...
export default function QuotePage() {
  return (
    <div className="article">
      <h1>Your Quote</h1>
      <p>
        Click "Checkout" to request a quote. A Labconco representative will work
        with our network of dealers to deliver pricing information to you.
      </p>
      <p>Click "Continue Browsing" to add more items to your Quote Cart.</p>
      {cartItem()}
    </div>
  );
}
